...
import 'package:mychat_app/features/chat/widgets/message_reply_preview.dart';
...
class _BottomChatFieldState extends ConsumerState<BottomChatField> {
  ...
  void sendTextMessage() async {
    if (isShowSendButton) {
      ...
      var path = '${tempDir.path}/my_chat_audio.aac';
      if (!isRecorderInit) {
        return;
      }
      if (isRecording) {
        ...
        showSnackBar(context: context, content: 'Recording stopped!!.');
      } else {
        await _soundRecorder!.startRecorder(toFile: path);
        showSnackBar(
            context: context, content: 'Recording started please speak.');
      }
